    ...
    cells = [
        ...
        },
        {
            ...
            "source": [
                ...
                "\n",
                "Run this once for the final configuration. Later framework runs reuse the same representation with `--reuse-representation --reuse-embeddings`. If Colab disconnects partway through, rerun this same cell and it will resume from the last saved SimCLR checkpoint.\n",
            ],
        },
        {
            "cell_type": "code",
