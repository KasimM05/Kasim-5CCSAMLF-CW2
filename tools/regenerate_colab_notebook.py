"""Regenerate the Colab notebook from a source-of-truth cell list."""
...
NOTEBOOK_PATH = Path(__file__).resolve().parents[1] / "tpcrp_colab.ipynb"
    ...
    cells = [
        {
            ...
            "source": [
                ...
                "\n",
                "This notebook is structured to be run top-to-bottom for marking: first validate the environment, then run a quick smoke test, then build the SimCLR cache once, then execute the baseline frameworks, and finally run the improvement experiment.\n",
                "\n",
        ...
        },
        {
            ...
            "source": [
                ...
                "\n",
                "Run this once for the practical final configuration. Later framework runs reuse the same representation with `--reuse-representation --reuse-embeddings`. If Colab disconnects partway through, rerun this same cell and it will resume from the last saved SimCLR checkpoint.\n",
            ],
        },
        {
            "cell_type": "code",
        ...
        },
        {
            ...
            "source": [
                ...
                "\n",
                "This is the first full coursework run to execute after the representation cache is ready. It keeps the full baseline set but uses reduced epochs and rounds so the coursework can be completed within a practical Colab budget.\n",
            ],
        },
        {
            "cell_type": "code",
        ...
        },
        {
            "cell_type": "markdown",
            "metadata": {},
            "source": ["## 11. Zip a result folder for download\n"],
        },
        {
            "cell_type": "code",
            "execution_count": None,
